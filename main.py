...
if __name__ == "__main__":
    ...
    # URL of the dataset on Kaggle
    # dataset_url = "https://www.kaggle.com/drgfreeman/rockpaperscissors/download"
    ...
    train_images, _ = train_test_split(os.listdir(
        train_dir), test_size=0.2, random_state=42)
    val_images, _ = train_test_split(os.listdir(
        val_dir), test_size=0.2, random_state=42)
    ...
    # You can use the following code to make predictions on new images:
    # Replace 'path_to_image.jpg' with the path to your image file.

    # Replace with the path to your image file.
    path_to_image = 'image.jpg'

    # Call the predict_image function from the predict.py script
    predicted_class = predict_image(path_to_image)
